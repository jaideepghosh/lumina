      ...
      <section className="pt-36 pb-24 text-center">
        <div className="text-center">
          ...
          <p className="text-gray-500">
            Welcome to Lumina, your premier destination for exploring a world of
            SaaS innovation and creativity through a diverse collection of
            application screenshots. We are a passionate team of individuals
            dedicated to fueling your inspiration, providing deep insights, and
            igniting entrepreneurial vision.
          </p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 grid-cols-1 gap-6 mt-16">
            <div className="bg-white p-6 rounded">
              <div className="flex gap-5">
                ...
                <div>
                  <h5 className="mb-2">For Designers</h5>
                  <p>
                    <span className="font-bold">Inspiration:</span> Lumina is
                    your source of artistic inspiration, where you can explore
                    beautifully designed SaaS applications to fuel your creative
                    endeavors. Discover the latest trends, color schemes, and
                    user interfaces that can elevate your design projects.
                  </p>
                </div>
              </div>
            </div>
            <div className="bg-white p-6 rounded">
              <div className="flex gap-5">
                ...
                <div>
                  <h5 className="mb-2">For Developers</h5>
                  <p>
                    <span className="font-bold">Insights:</span> Lumina provides
                    you with a unique perspective into application workflows and
                    user experiences. Dive deep into the functionality and user
                    interactions of various SaaS apps, helping you refine your
                    development skills and make informed choices in your
                    projects.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white p-6 rounded">
              <div className="flex gap-5">
                ...
                <div>
                  <h5 className="mb-2">For Entrepreneurs</h5>
                  <p>
                    <span className="font-bold">Ideas:</span> Lumina offers a
                    wealth of innovative concepts and solutions that can inspire
                    your entrepreneurial journey. Explore the displayed content
                    to spark new ideas for your own SaaS ventures or business
                    improvements.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white p-6 rounded">
              <div className="flex gap-5">
                ...
                <div>
                  <h5 className="mb-2">For the World</h5>
                  <p>
                    We are committed to the principles of open-source
                    collaboration, making Lumina a hub for knowledge sharing and
                    innovation. Join us on this journey as we celebrate the
                    world of SaaS and empower creative minds, technical
                    enthusiasts, and ambitious entrepreneurs.
                  </p>
                </div>
              </div>
            </div>
